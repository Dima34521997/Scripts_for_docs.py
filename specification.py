...
comment_categories = {}  # Категории примечаний
...
def execute(input_files: list, is_civ: bool):
    global dfs, files, dict_chars, comment_not_install, comment_categories, final_df, data, civ, components_one_manuf_categories
    civ = is_civ
    files = input_files
    ...
    for file in files:
        ...
        dict_chars, d_not_install, comment_categories, one_man_cats = obshiy_perechen.get_components(dict_chars, dfs, [file])
